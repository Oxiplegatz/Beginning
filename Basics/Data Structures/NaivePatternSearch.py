...
friends_intro = "Pylhon is a wonderful Language that zzz is beloved for its ease" \
                " zzz of use and simple syntacs. While zzz at some times the performance" \
                " can be less than iDil, by properly zzz utilizing built-in libraries and other" \
                " languuUuage features, pylhon's performance zzz can approach that of C."
